...
export PATH_CCACHE_ROOT="${PATH_BUILD_ROOT}/.ccache"
export PATH_ANDROID_ROOT="${PATH_BUILD_ROOT}/${ANDROID_DISTRO}_${ANDROID_VERSION}"
...
function fEnvSetup_ccache()
{
    fPrint_title "${FUNCNAME[0]}"
    if command -v ccache
    then
        export USE_CCACHE=1
        export CCACHE_DIR="${PATH_CCACHE_ROOT}"
